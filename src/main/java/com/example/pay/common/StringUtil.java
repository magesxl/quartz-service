 ...
 * </p>
 * @author sean won
 * @version $Id: StringUtil.java, v 0.1 2009-9-17 下午10:31:47 fuyangbiao Exp $
 */
...
public class StringUtil {
    ...
    /**
     * 获取字符串中，第一个中文字符之后的字符串。
     * 中文类型的逗号，冒号，句号等，不算作中文字符。
     * @author wuhaoxiang
     * @param str 要扫描的字符串
     ...
     * @return
     */
    public static List<String> toList(String inputString, String split) {
        ...
        for (String s : inputString.split(split)) {
            outList.add(s);
        }
     ...
     * @return
     */
    public static List<Long> toNumberList(String inputString, String split) {
        List<String> orgiList = toList(inputString, split);
        List<Long> destList = new ArrayList<Long>();
        for (String s : orgiList) {
            destList.add(Long.valueOf(s));
        }
     ...
     * @return
     */
    public static int extIndexOf(String inputString, char matchTag, int matchTimes) {
        int count = 0;
